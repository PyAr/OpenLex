...
def test_edituser(page, login):
    # Click text=Bienvenido Juan
    page.click("text=Bienvenido Juan")

    # Click text=Perfil
    page.click("text=Perfil")
    assert page.url.endswith("/default/user/profile?_next=/OpenLex/dashboard/view")
    ...
    assert page.url.endswith("/default/user/change_password?_next=/OpenLex/dashboard/view")
    ...
    assert page.url.endswith("/default/index")
    ...
    assert page.url.endswith("/default/user/login?_next=/OpenLex/default/index")
